...
describe('InputsFromCwl', () => {
    ...
    expect(
      getInputsFromCwl(
        ...
        (_file: string) => {
          return JSON.parse(
            readFileSync(
              'src/__tests__/data/doubles/6171ac4137b0b158411138e4-workflow.cwl',
              'utf8',
            ),
        ...
        (_file: string) => {
          return JSON.parse(
            readFileSync(
              'src/__tests__/data/doubles/6171ac4137b0b158411138e4-params.json',
              'utf8',
            ),
  ...
  it('montage-recycle', () => {
    const workflowHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/montage-recycle-workflow.cwl',
          'utf8',
        ),
      ) as CwlWorkflowTemplate;
    };
    const parameterHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/montage-recycle-params.json',
          'utf8',
        ),
      ) as Record<string, string>;
    };
    const outputHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/montage-recycle.out.json',
          'utf8',
        ),
      ) as OutputDict;
    };
  ...
  it('zarr-format', () => {
    const workflowHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/scatter-format-workflow.cwl',
          'utf8',
        ),
      ) as CwlWorkflowTemplate;
    };
    const parameterHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/scatter-format-params.json',
          'utf8',
        ),
      ) as Record<string, string>;
    };
  ...
  it('Dynamic Scatter', () => {
    const workflowHandler = (file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/dynamic-scatter-operator-workflow.cwl',
          'utf8',
        ),
      ) as CwlWorkflowTemplate;
    };
    const parameterHandler = (file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/dynamic-scatter-params.json',
          'utf8',
        ),
      ) as Record<string, string>;
    };
    const outputHandler = (_file: string) => {
      return JSON.parse(
        readFileSync(
          'src/__tests__/data/doubles/dynamic-scatter.out.json',
          'utf8',
        ),
      ) as OutputDict;
    };
