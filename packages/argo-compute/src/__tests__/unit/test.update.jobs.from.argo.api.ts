...
describe('Test argo status api', () => {
  it('Test argo status api', async () => {
    const argoJobStatus = JSON.parse(
      readFileSync('src/__tests__/data/doubles/argo-test.json', 'utf8'),
    );
    ...
    const montageLog = buildContainerUrl(
      '6182b31d18a40d33bc351ef0',
      '6181a1d9d8f17a0e454c3e47-1519731056',
    );
    const recycleLog = buildContainerUrl(
      '6182b31d18a40d33bc351ef0',
      '6181a1d9d8f17a0e454c3e47-2464799912',
    );
    const actualValue = [
      {
        driver: 'ARGO',
      ...
      },
      {
        ...
        inputs: {
          ...
          collectionDir:
            '/data/inputs/collections/611f403652091f3ee8e9c25a/images',
